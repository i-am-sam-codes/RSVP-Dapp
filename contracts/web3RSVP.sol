...
contract Web3RSVP {
    ...
    function createNewEvent(
        ...
        function withdrawUnclaimedDeposits(bytes32 eventId) external {
            ...
            // check that the paidOut boolean still equils false AKA the money hasnt already been paid out
            require(!myEvent.paidOut, "ALREADY PAID");

            // check if its been 7days past myEvent.eventTimestamp
            require(
